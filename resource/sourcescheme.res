...
Scheme
{
	...
	BaseSettings
	{
		...
		Border.Selection				"BorderSelection"	// the additional border colour for displaying the default/selected button
		...
		CheckButton.Check				"TFTanBright"		// colour of the check itself
