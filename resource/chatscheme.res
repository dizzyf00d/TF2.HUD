...
Scheme
{
	//////////////////////// COLOURS ///////////////////////////
	// colour details
	// this is a list of all the colours used by the scheme
	Colors
	{
		// base colours
	...
	BaseSettings
	{
		// vgui_controls colours specifications
		Border.Bright					"200 200 200 196"	// the lit side of a control
		Border.Dark						"40 40 40 196"		// the dark/unlit side of a control
		Border.Selection				"0 0 0 196"			// the additional border colour for displaying the default/selected button
		...
		CheckButton.Check				"White"				// colour of the check itself
		...
		ScrollBarSlider.FgColor				"Blank"			// nob colour
		ScrollBarSlider.BgColor				"255 255 255 64"	// slider background colour
